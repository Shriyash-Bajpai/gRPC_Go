...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\x05proto\x1a\x14memory_message.proto\"\x88\x01\n" +
	"\aStorage\x12-\n" +
	"\x06driver\x18\x01 \x01(\x0e2\x15.proto.Storage.DriverR\x06driver\x12%\n" +
	"\x06memory\x18\x02 \x01(\v2\r.proto.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\a\n" +
	"\x03HDD\x10\x01\x12\a\n" +
	"\x03SSD\x10\x02B)Z'github.com/shriyash/grpc_practice/pb;pbb\x06proto3"
