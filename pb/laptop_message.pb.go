...
const file_laptop_message_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_message.proto\x12\x05proto\x1a\x14screen_message.proto\x1a\x17processor_message.proto\x1a\x14memory_message.proto\x1a\x15storage_message.proto\x1a\x16keyboard_message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe4\x03\n" +
	"\x06Laptop\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05brand\x18\x02 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1c\n" +
	"\x03cpu\x18\x04 \x01(\v2\n" +
	".proto.CPUR\x03cpu\x12\x1f\n" +
	"\x03ram\x18\x05 \x01(\v2\r.proto.MemoryR\x03ram\x12\x1e\n" +
	"\x04gpus\x18\x06 \x03(\v2\n" +
	".proto.GPUR\x04gpus\x12*\n" +
	"\bstorages\x18\a \x03(\v2\x0e.proto.StorageR\bstorages\x12%\n" +
	"\x06screen\x18\b \x01(\v2\r.proto.ScreenR\x06screen\x12+\n" +
	"\bkeyboard\x18\t \x01(\v2\x0f.proto.KeyboardR\bkeyboard\x12\x1d\n" +
	"\tweight_kg\x18\n" +
	...
	"\x06weightB)Z'github.com/shriyash/grpc_practice/pb;pbb\x06proto3"
