...
const file_processor_message_proto_rawDesc = "" +
	"\n" +
	"\x17processor_message.proto\x12\x05proto\x1a\x14memory_message.proto\"\xab\x01\n" +
	"\x03CPU\x12\x14\n" +
	...
	"\amax_ghz\x18\x06 \x01(\x01R\x06maxGhz\"\x88\x01\n" +
	"\x03GPU\x12\x14\n" +
	"\x05brand\x18\x01 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x17\n" +
	"\amin_ghz\x18\x03 \x01(\x01R\x06minGhz\x12\x17\n" +
	"\amax_ghz\x18\x04 \x01(\x01R\x06maxGhz\x12%\n" +
	"\x06memory\x18\x05 \x01(\v2\r.proto.MemoryR\x06memoryB)Z'github.com/shriyash/grpc_practice/pb;pbb\x06proto3"
