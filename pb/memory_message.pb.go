...
const file_memory_message_proto_rawDesc = "" +
	"\n" +
	"\x14memory_message.proto\x12\x05proto\"\xa6\x01\n" +
	"\x06Memory\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\x12&\n" +
	"\x04unit\x18\x02 \x01(\x0e2\x12.proto.Memory.UnitR\x04unit\"^\n" +
	"\x04Unit\x12\v\n" +
	...
	"\bTERABYTE\x10\x06B)Z'github.com/shriyash/grpc_practice/pb;pbb\x06proto3"
