...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\x05proto\"\x8f\x02\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x128\n" +
	"\n" +
	"resolution\x18\x02 \x01(\v2\x18.proto.Screen.ResolutionR\n" +
	"resolution\x12)\n" +
	"\x05panel\x18\x03 \x01(\x0e2\x13.proto.Screen.PanelR\x05panel\x12\x1e\n" +
	"\n" +
	...
	"\x04OLED\x10\x02B)Z'github.com/shriyash/grpc_practice/pb;pbb\x06proto3"
